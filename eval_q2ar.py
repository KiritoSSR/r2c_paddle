...
parser.add_argument(
    '-answer_preds',
    dest='answer_preds',
    default='model/saves/flagship_answer/valpreds.npy',
...
parser.add_argument(
    ...
    default='model/saves/flagship_rationale/valpreds.npy',
...
with open(os.path.join('data', '{}.jsonl'.format(args.split)), 'r') as f:
    for l in f:
        item = json.loads(l)
